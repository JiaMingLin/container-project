...
IP=""
REDHAT_VERSION=64
RSERVE_VERSION=${RSERVER_VERSION_MAJOR}.${RSERVER_VERSION_MINOR}
VERSION=8.0
MINOR_VERSION=0
REVO_VERSION=8.0.0
REVO_BIN_STRING=Revo-$VERSION
R_VERSION=R-${RRO_VERSION_MAJOR}.${RRO_VERSION_MINOR}
LINUX_VERSION=5
TOMCAT_VERSION=7.0.64
TOMCAT_SSL_PORT=8011
TOMCAT_PORT=8010
...
R=1
RBIN="/usr/bin/R"
R_HOME=/usr/lib64/RRO-${RRO_VERSION_MAJOR}.${RRO_VERSION_MINOR}/R-${RRO_VERSION_MAJOR}.${RRO_VERSION_MINOR}/lib64/R
LINUX=redhat
DB_PATH=""
